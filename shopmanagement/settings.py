...
ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', 'localhost,127.0.0.1,172.19.9.194, shop-management.fly.dev,172.19.39.210,shop-management.fly.dev').split(',')
...
if DATABASE_URL:
    ...
    # If we are NOT in production (local dev), use SQLite
    DATABASES = {
        'default': {
